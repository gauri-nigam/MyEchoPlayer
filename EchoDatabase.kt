...
/**
 * Created by Gauri Nigam on 1/7/2018.
 */
class EchoDatabase: SQLiteOpenHelper{
    ...
    fun queryDBList():ArrayList<Songs>?{
        ...
        try{
            ...
            val query_params="SELECT * FROM " + Staticated.TABLE_NAME// to fetch a value, we make a query for it
    ...
    fun checkifIdExists(_id: Int): Boolean{
        ...
        var storeId=-1090
        val db= this.readableDatabase
        val query_params ="SELECT * FROM " + Staticated.TABLE_NAME + " WHERE SongID = $_id"// searches for the specific row in the column of songid in the table
        var cSor = db.rawQuery(query_params, null)
        if(cSor.moveToFirst())
        {
            do {
        ...
        return storeId != -1090// will return true if song found
    }
