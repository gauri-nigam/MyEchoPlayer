...
class MainScreen : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        songTitle = view?.findViewById<TextView>(R.id.songMainTitleScreen)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        // FavouriteFragment.Statified.mediaPlayer.bottomBarSetup()
    }
    ...
    fun getSongsFromPhone(): ArrayList<Songs> {//added
